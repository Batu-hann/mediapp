export const i18n = {
  tr: {
    ...
    deleteConfirmChat: 'Bu sohbeti ve tüm mesajlarını silmek istediğinizden emin misiniz?',
    renameTitle: 'Sohbeti Yeniden Adlandır',
    renamePlaceholder: 'Yeni sohbet başlığı...',
    // Camera
    scanTitle: 'İlaç Tara',
  ...
  en: {
    ...
    deleteConfirmChat: 'Are you sure you want to delete this chat and all its messages?',
    renameTitle: 'Rename Chat',
    renamePlaceholder: 'New chat title...',
