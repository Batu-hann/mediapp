...
const styles = StyleSheet.create({
  ...
  preview: { backgroundColor: colors.chatAi, borderRadius: radius.xl, height: 280, justifyContent: 'center', alignItems: 'center', overflow: 'hidden', borderWidth: 1, borderColor: colors.borderLight },
  ...
  placeholderText: { color: colors.textMuted, fontSize: 14, fontWeight: '500', textAlign: 'center', lineHeight: 22 },
